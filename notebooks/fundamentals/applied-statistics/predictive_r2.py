...
def _(X_1, pd, plt, sns, y_1):
    ...
    sns.heatmap(correlation_matrix, annot=True, cmap='RdBu', vmin=-1, vmax=1, center=0, square=True, fmt='.2f', annot_kws={'size': 10}, cbar_kws={'label': 'Correlation Coefficient'})
...
def _(H, H_diagonal, condition_number, y_2):
    ...
    results = {'condition_number': condition_number.item(), 'R2': r2.item(), 'predicted_R2': predicted_r2.item(), 'PRESS': PRESS.item(), 'SSE': SSE.item(), 'TSS': TSS.item()}
