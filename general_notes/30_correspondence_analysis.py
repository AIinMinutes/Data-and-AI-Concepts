...
def _():
    ...
    dataset.columns = ["Wins", "Draws", "Losses", "Goals", "Conceded", "Points"]
...
def _(dataset, prince):
    ca = prince.CA(n_components=2, n_iter=100, copy=True, check_input=True, engine="sklearn", random_state=47)
