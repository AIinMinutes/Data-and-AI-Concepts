...
def _(A, itemlabels, plt, sns, userlabels):
    ...
    sns.heatmap(A, annot=True, cmap="Blues", xticklabels=itemlabels, yticklabels=userlabels, cbar=False)
...
def _(U, plt, sns, userlabels):
    ...
    sns.heatmap(U, annot=True, cmap="Greens", xticklabels=userlabels, yticklabels=userlabels, cbar=False)
...
def _(I, itemlabels, plt, sns):
    plt.figure(figsize=(4, 4), dpi=300)
    sns.heatmap(I, annot=True, cmap="Reds", xticklabels=itemlabels, yticklabels=itemlabels, cbar=False)
