...
def _(np, plt, x, y, z1, z2):
    ...
    ax1.plot_surface(
        x, y, z1, alpha=0.8, cmap="Blues", edgecolor="k", rstride=10, cstride=10, label="P1: 2x + 3y + 4z = 0"
    )
    ax1.plot_surface(
        x, y, z2, alpha=0.8, cmap="Reds", edgecolor="k", rstride=10, cstride=10, label="P2: 2x + 3y + 4z - 10 = 0"
    )
