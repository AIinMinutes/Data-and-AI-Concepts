...
def _():
    ...
    def plot_matrix_energy_visualization(
        A, title_prefix, cmap="coolwarm", scatter=False, scatter_label="", scatter_color="skyblue"
    ):
        """
        ...
        ax2.quiver(
            0, 0, line_min[0], line_min[1], angles="xy", scale_units="xy", scale=10, color="black", label="Direction-1"
        )
        ax2.quiver(
            0, 0, line_max[0], line_max[1], angles="xy", scale_units="xy", scale=10, color="white", label="Direction-2"
        )
