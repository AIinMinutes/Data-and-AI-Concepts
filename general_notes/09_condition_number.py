...
def _(data, plt, sns):
    ...
    pp = sns.pairplot(
        data, kind="kde", height=2, corner=True, diag_kws={"color": "brown"}, plot_kws={"color": "magenta"}
    )
    plt.suptitle("Relationships among Predictors and Response", y=1.02, fontsize=16)
    plt.show()
    return
