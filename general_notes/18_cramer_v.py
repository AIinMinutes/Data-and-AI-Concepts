...
def _():
    ...
    data = [
        ("Data Scientist", "Action", 50),
        ("Data Scientist", "Comedy", 20),
        ("Data Scientist", "Drama", 5),
        ("ML Engineer", "Action", 5),
        ("ML Engineer", "Comedy", 20),
        ("ML Engineer", "Drama", 50),
        ("GenAI Developer", "Action", 5),
        ("GenAI Developer", "Comedy", 50),
...
def _(df):
    ...
    contingency_df = df.pivot(index="Movie Genre", columns="Role", values="Count")
    contingency_df
...
def _(chi2_contingency, contingency_df):
    ...
    chi2_stat, p_val, dof, expected = chi2_contingency(contingency_df)
