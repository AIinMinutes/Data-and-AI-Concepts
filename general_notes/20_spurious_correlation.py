...
def _():
    ...
    from utils import plot_regression_and_heatmap_plots, validate_plot_config  # Plotting utilities
...
def _(data, pg):
    ...
    partial_corr_coefficient = pg.partial_corr(data=data, x="X", y="Y", covar="Z", method="pearson")
